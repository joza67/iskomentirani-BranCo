...
{
    /// <inheritdoc />
    public partial class UpdateNotNullLoRaData : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecvTime = table.Column<long>(type: "bigint", nullable: false),
                    TemperatureFlow = table.Column<int>(type: "int", nullable: false),
                    Volume = table.Column<int>(type: "int", nullable: false),
                    VolumeFlow = table.Column<int>(type: "int", nullable: false),
                    WaterMeterEui = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LobaroDataFrame", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
        }
    }
